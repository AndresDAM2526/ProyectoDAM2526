        ...
        child: Column(
          children: [
            Container(
              ...
              child: TextFormField(
                controller: context.read<AdduserFormViewmodel>().nameController,
                validator: (value) =>
                    context.read<AdduserFormViewmodel>().checkName(value),
            ...
            Container(
              margin: EdgeInsets.all(10),
              child: TextFormField(
                controller: context.read<AdduserFormViewmodel>().userController,
                validator: (value) =>
                    context.read<AdduserFormViewmodel>().checkUser(value),
            ...
            Container(
              ...
              child: TextFormField(
                controller: context
                    ...
                    .passwordController,
                validator: (value) =>
                    context.read<AdduserFormViewmodel>().checkPassword(value),
              ...
              child: FutureBuilder(
                ...
                builder: (context, snapshot) {
                  ...
                  return DropdownButtonFormField(
                    validator: (value) =>
                        context.read<AdduserFormViewmodel>().checkRole(value),
